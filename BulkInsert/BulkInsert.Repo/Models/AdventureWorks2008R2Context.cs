...
using BulkInsert.Repo.Models.Mapping;

namespace BulkInsert.Repo.Models
{
    public partial class AdventureWorks2008R2Context : DbContext
    {
        static AdventureWorks2008R2Context()
        {
            Database.SetInitializer<AdventureWorks2008R2Context>(null);
        }

        public AdventureWorks2008R2Context()
            : base("Name=AdventureWorks2008R2Context")
        {
        }
